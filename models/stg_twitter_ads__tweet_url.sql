...
final as (
    ...
    select
        ...
        {{ twitter_source.twitter_ads_extract_url_parameter('expanded_url', 'utm_source') }} as utm_source,
        {{ twitter_source.twitter_ads_extract_url_parameter('expanded_url', 'utm_medium') }} as utm_medium,
        {{ twitter_source.twitter_ads_extract_url_parameter('expanded_url', 'utm_campaign') }} as utm_campaign,
        {{ twitter_source.twitter_ads_extract_url_parameter('expanded_url', 'utm_content') }} as utm_content,
        {{ twitter_source.twitter_ads_extract_url_parameter('expanded_url', 'utm_term') }} as utm_term
