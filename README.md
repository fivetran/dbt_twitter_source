...
By default this package will build the Twitter staging models within a schema titled (<target_schema> + `_stg_twitter_ads`) in your target database. If this is not where you would like your Twitter staging data to be written to, add the following configuration to your `dbt_project.yml` file:
