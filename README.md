# [DEPRECATED] Twitter Ads Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_twitter`](https://github.com/fivetran/dbt_twitter) instead, which now contains all models previously found here._
